...
# Set REVENDOR_HOST_NODE_BIN to the Node 24.21.0 bin directory for host npm commands.
set -euo pipefail
...
NODE
echo "Re-vendored $pin_sha. Run the RI typecheck and suite with CI's Node 24.21.0."
