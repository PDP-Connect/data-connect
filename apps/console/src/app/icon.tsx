...
const DATACONNECT_ICON = `<svg aria-label="DataConnect" role="img" viewBox="0 0 832 832" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="dataconnect-icon-bg" x1="416" x2="416" y1="0" y2="832" gradientUnits="userSpaceOnUse">
      <stop offset="0.100024" stop-color="#304DC0" />
      <stop offset="0.578171" stop-color="#121265" />
      <stop offset="0.956731" stop-color="#090939" />
    </linearGradient>
  </defs>
  <rect fill="url(#dataconnect-icon-bg)" height="832" rx="183" width="832" />
...
export default function Icon() {
  return new Response(DATACONNECT_ICON, {
